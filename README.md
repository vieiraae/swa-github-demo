...
<!-- .slide: data-background="https://gcdnb.pbrd.co/images/HMYtyfV1WzCr.png?o=1" -->
...
* It's just right there available with any new repo
* Run a workflow on any GitHub event
* Automate code reviews, branch management, issue tracking, releases, ...
...
* Popular Open Source projects depend on GitHub Actions to deliver new releases every sngle day
...
[EXTENSIBILITY]()
### Marketplace with 18k+ Actions

* There's an Action for that...
* Actions are certified by major vendors
* Use Hosted runners or bring your VM / container
* Easily deploy to hybrid and multi-cloud
